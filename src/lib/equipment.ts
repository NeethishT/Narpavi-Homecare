...
export const EQUIPMENT_ITEMS: EquipmentItem[] = [
  {
    ...
    metaDesc: 'Rent or buy BiPAP, CPAP, and Oxygen Concentrators at home in Chennai. Installation, setup guidance and technician support.',
  ...
  },
  {
    ...
    metaDesc: 'Rent or buy patient monitors and pulse oximeters in Chennai for home care and post-hospital recovery.',
  ...
  },
  {
    ...
    metaDesc: 'Rent home ventilators in Chennai with setup coordination for ICU at home and critical respiratory care.',
  ...
  },
  {
    ...
    metaDesc: 'Rent oxygen cylinders in Chennai for home oxygen support with flowmeter and refill assistance.',
    ...
    features: ['Pressure-tested cylinders', 'Sanitized handling process', 'Simple usage explanation', 'Fast delivery coordination in Chennai'],
  ...
  },
  {
    ...
    metaDesc: 'Rent or buy anti-bedsore air mattresses in Chennai for bedridden patients and elder care.',
  ...
  },
  {
    ...
    metaDesc: 'Rent or buy hospital beds and fowler cots in Chennai for home patient care.',
  ...
  },
  {
    ...
    metaDesc: 'Rent or buy wheelchairs, walkers and mobility aids in Chennai for home care.',
  ...
  },
  {
    ...
    metaDesc: 'DVT pump rental in Chennai with compression sleeves for post-surgery and bedridden patients.',
  ...
  },
  {
    ...
    metaDesc: 'Rent suction machines in Chennai for phlegm removal, tracheostomy support and home respiratory care.',
  ...
  },
  {
    ...
    metaDesc: 'Buy BiPAP masks, CPAP masks, oxygen tubing and respiratory accessories in Chennai.',
