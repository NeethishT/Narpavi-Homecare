...
export const CARE_PACKAGES: CarePackage[] = [
  {
    ...
    scope: [
      ...
      { category: 'Basic Vital Monitoring', detail: 'Temp / BP / Pulse / SpO₂, Daily vitals & reporting' },
      { category: 'Safety & Fall Prevention', detail: 'Home safety tips & checks' },
      { category: 'Companionship & Social Support', detail: 'Conversation & light activities' },
  ...
  },
  {
    ...
    bestFor: [
      'Adults with chronic illnesses (diabetes, hypertension, asthma) needing safe routine care',
      'Early neurological conditions (Parkinson’s, mild stroke recovery, MS)',
    ...
    scope: [
      { category: 'Activities of Daily Living (ADLs)', detail: 'Full ADL help incl. toileting & mobility' },
      { category: 'Mobility Support', detail: 'Routine mobility + safety checks' },
      { category: 'Nutrition Support', detail: 'Hydration reminders' },
      { category: 'Medication Support', detail: 'Structured reminders & routine check-ins' },
      { category: 'Basic Vital Monitoring', detail: 'Daily vitals & reporting' },
      { category: 'Safety & Fall Prevention', detail: 'Daily environment safety checks' },
  ...
  },
  {
    ...
    scope: [
      { category: 'Activities of Daily Living (ADLs)', detail: 'Full ADL + assisted transfers & repositioning' },
      { category: 'Mobility Support', detail: 'Repositioning & fall prevention' },
      { category: 'Nutrition Support', detail: 'Full feeding support & meal planning with family' },
      { category: 'Medication Support', detail: 'Strict reminder schedule & safety reporting' },
      { category: 'Basic Vital Monitoring', detail: 'Daily vitals + escalation if abnormal' },
      { category: 'Safety & Fall Prevention', detail: 'Active fall prevention & transfer support' },
      { category: 'Companionship & Social Support', detail: 'Ongoing companionship & engagement' },
      { category: 'Family Communication', detail: 'Daily log + weekly supervisor call' },
      { category: 'Post-Hospital / Recovery Care', detail: 'Intensive mobility & ADL support' },
      { category: 'Palliative / Comfort Support', detail: 'Comfort routines & presence' },
      { category: 'Emergency Backup', detail: '24x7 backup & nurse guidance' },
    ],
  ...
  },
  {
    ...
    bestFor: [
      ...
      'PostICU discharge adults requiring total daily support but no medical procedures',
    ],
    highlights: [
    ...
    scope: [
      { category: 'Activities of Daily Living (ADLs)', detail: 'Complete ADL & bedside hygiene' },
      { category: 'Mobility Support', detail: 'Full repositioning & pressure sore prevention' },
      { category: 'Nutrition Support', detail: 'Complete feeding assistance & comfort meals' },
      { category: 'Medication Support', detail: 'Strict reminders & full documentation' },
      { category: 'Basic Vital Monitoring', detail: 'Continuous vitals logging & supervisor review' },
      { category: 'Safety & Fall Prevention', detail: 'Full safety support incl. bed rails & positioning' },
      { category: 'Companionship & Social Support', detail: 'Comfort presence & emotional support' },
      { category: 'Family Communication', detail: 'Daily logs + frequent family updates & escalation plan' },
      ...
      { category: 'Emergency Backup', detail: '24x7 backup & escalation + supervisor oversight' },
    ],
